...
namespace PryKaplanTrabajo
{
    ...
    {
        //Objetos que voy a necesitar para la base
        ...
        public bool ValidarUsuarios(String Usuario, String Contraseña)
        {
            ...
            try
            {
                //Selecciono desde mi base de datos en Access
                ...
                {
                    // Agrega dos parámetros a esta consulta (@Usuario y @Contraseña) utilizando el método AddWithValue.
                    // Estos parámetros se reemplazarán con los valores proporcionados
